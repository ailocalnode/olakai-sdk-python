...
class MiddlewareManager:
    ...
    def add_middleware(self, middleware: Middleware) -> None:
        ...
        safe_log('info', f"Added middleware: {middleware.name} to instance {self.instance_id}")
    ...
    def remove_middleware(self, name: str) -> None:
        ...
        safe_log('info', f"Removed middleware: {name} from instance {self.instance_id}")
...
def add_middleware(middleware: Middleware) -> None:
    ...
    safe_log('warning', f"Using deprecated global middleware. Consider using instance-based middleware.")
